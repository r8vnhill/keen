 ...
 *
 * This function is useful in testing scenarios where pairs of elements need to follow a specific order, such as being
 * sorted or strictly different. It generates pairs where the elements are ordered based on their natural ordering, with
 * options to enforce strict inequality or reversed ordering.
 *
 * ## Usage:
...
) where T : Comparable<T> = Arb.pair(a, b)
    .filter { (first, second) ->
