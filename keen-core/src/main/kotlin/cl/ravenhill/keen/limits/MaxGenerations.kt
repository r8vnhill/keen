...
data class MaxGenerations<T, F, I>(
    val generations: Int,
    val configuration: ListenerConfiguration<T, F> = ListenerConfiguration()
) : ListenLimit<T, F, I>(MaxGenerationsListener(configuration), { state -> state.generation >= generations }
