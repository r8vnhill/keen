 ...
 * implements the [FitnessEvaluable], [Verifiable], and [FlatMappable] interfaces, allowing it to be evaluated for
 * fitness, verified for consistency, and support flat-mapping operations.
 *
 * ## Usage:
