 ...
 * population within an [GeneticEvolutionState]. The `force` parameter can be set to `true` to force re-evaluation of all
...
class SequentialEvaluator<T, G>(private val function: (Genotype<T, G>) -> Double) :
    ...
    /**
     * Evaluates the population of an [GeneticEvolutionState] using the provided fitness function.
     *
     ...
     */
    override fun invoke(state: GeneticEvolutionState<T, G>, force: Boolean) =
