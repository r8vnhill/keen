...
open class Fun<T>(
    ...
    private val body: (Array<out T>) -> T
) : Reduceable<T> {
    override var parent: Fun<T>?
    ...
    override fun deepCopy(): Reduceable<T> {
        return Fun(name, arity, body).also {
            it.parent = parent
        }
    }
    ...
    override fun invoke(args: Array<out T>) = body(args)

    override fun toString() = name
    operator fun set(i: Int, value: Reduceable<T>) {
        TODO()
    }
}
