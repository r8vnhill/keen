...
class FitnessMaximizerTest : FreeSpec({
    "A [FitnessMaximizer]" - {
        "can compare two individuals when" - {
            "both have the same fitness" {
                checkAll(Arb.intGenotype(), Arb.intGenotype(), Arb.real()) { g1, g2, f ->
                    ...
                    FitnessMaximizer<Int, IntGene>().compare(i1, i2) shouldBe 0
                }
            }
            ...
            "the first has a higher fitness" {
                checkAll(
                    ...
                    FitnessMaximizer<Int, IntGene>().compare(i1, i2) shouldBe -1
                }
            }
            ...
            "the second has a higher fitness" {
                checkAll(
                    ...
                    val i1 = Individual(g1, f1)
                    val i2 = Individual(g2, f2)
                    FitnessMaximizer<Int, IntGene>().compare(i2, i1) shouldBe 1
                }
            }
        }
    }
