//[keen-core](../../../index.md)/[cl.ravenhill.keen.listeners.precision](../index.md)/[WholeHours](index.md)

# WholeHours

[common]\
data object [WholeHours](index.md) : [TimePrecision](../-time-precision/index.md)

A [TimePrecision](../-time-precision/index.md) implementation that provides precision in whole hours.

## Properties

| Name | Summary |
|---|---|
| [unit](unit.md) | [common]<br>open override val [unit](unit.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>The unit of time precision, represented as `"h"`. |
